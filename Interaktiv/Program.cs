...
{
    Console.Write("klicka på <Enter> för att avsluta... ");
...
string HoppaUt = Console.ReadLine();
...
if (HoppaUt == "ja")
{
    ...
    Console.ReadLine();
        ...
        while (Gömma != "ja" && Gömma != "nej" )
    {
        Gömma = Console.ReadLine();
        ...
        {
            Console.Clear();
            Console.WriteLine("Du gömmer dig för bilen och samma svarta skåpbil som kidnappade dig åkte förbi");
...
{
    Console.Clear();
    Console.WriteLine("Maskerade mannen hoppar ut ur bilen och slår till dig medvetslös");
    Console.WriteLine("");
    Console.WriteLine(" *En timme efter* ");
    Console.WriteLine("");
    Console.WriteLine("Du vaknar upp av iskallt vatten som hälls över dig");
